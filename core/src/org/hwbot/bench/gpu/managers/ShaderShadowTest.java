...
public class ShaderShadowTest extends BenchmarkState {
    ...
    public ShaderShadowTest(GameStateManager gsm) {
        super(gsm);
    }
    ...
    public boolean init() {
        ...
        try {
            ...
            program = new ShaderProgram(Gdx.files.internal("data/shaders/complex/passthrough.vert").readString(), Gdx.files.internal(
                    "data/shaders/complex/fernLightning.frag").readString());
    ...
    public void draw() {
        ...
        program.setUniform2fv("mouse", new float[] { 0.1f + (time / 15f), 0.7f }, 0, 2);
