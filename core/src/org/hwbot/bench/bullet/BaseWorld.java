...
public class BaseWorld<T extends BaseEntity> implements Disposable {
    ...
    public void render(final ModelBatch batch, final ModelBatch shadowbatch, final Environment lights) {
        render(batch, shadowbatch, lights, entities);
    }
    ...
    public void render(final ModelBatch batch, final ModelBatch shadowbatch, final Environment lights, final Iterable<T> entities) {
        for (final T e : entities) {
            batch.render(e.modelInstance, lights);
            shadowbatch.render(e.modelInstance, lights);
        }
    }
